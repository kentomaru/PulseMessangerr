...
const SECTIONS: { icon: React.ReactNode; title: string; items: string[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      "«Показывать прочтение сообщений» — собеседник не увидит, что вы открыли сообщение.",
      "«Показывать мои истории другим» — полностью скрывает ваши истории от других пользователей.",
